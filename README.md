...
- Jamis Buck maze generation notes (Prim and others):  
  <https://weblog.jamisbuck.org/>
- Maze generation overview video:  
  <https://www.youtube.com/watch?v=U3meEXvYFsc>
- Procedural generation discussion around Wilson-style approaches:  
  <https://www.reddit.com/r/proceduralgeneration/comments/g2160z/processing_maze_generation_using_wilsons_algorithm/>
...
- Output maze file is written under `output/`
...
- stronger automated tests (unit + integration for parser/generator/solver)
- performance profiling on larger maze sizes
- add more generation/solver strategies
- seed support for deterministic maze reproduction
- cleaner packaging and CLI flags (direct argument override of config keys)
- richer MiniLibX UX (dropdown/list widgets instead of cycle buttons)
