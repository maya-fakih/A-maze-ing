...
class MazeSolver(ABC):
    ...
    def __init__(self, maze: MazeGenerator) -> None:
        """Initialize solver state for a maze. Args: maze maze generator to solve. Returns: None."""
        self.maze = maze
    ...
    def reachable_neighbors(self, cell: tuple) -> list:
        """Return adjacent cells reachable without crossing walls. Args: cell current cell coordinates. Returns: Reachable neighbor tuples."""
        nx, ny = cell
        reachable = []
    ...
    def solve(self) -> List[str]:
        """Compute move sequence from entry to exit. Args: self solver instance. Returns: Direction list representing solution."""
        raise NotImplementedError

    def huristic(self, cell: tuple) -> int:
        """Estimate Manhattan distance to exit. Args: cell current coordinates. Returns: Heuristic distance integer."""
        x1, y1 = cell
