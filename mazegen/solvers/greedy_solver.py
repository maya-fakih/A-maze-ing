...
class GreedySolver(MazeSolver):
    ...
    def priority(self, cell: tuple) -> int:
        """
            Compute greedy priority score. Args: cell candidate cell
    ...
    def solve(self) -> List[str]:
        """
            Solve maze with greedy best-first search. Args: self solver
            instance. Returns: Direction list from entry to exit.
        """
